  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          type: 'status',
          message: `${existingPatient ? 'Patient readmitted' : 'New patient admitted'}: ${formData.name}`,
          severity: 'info',
          user_id: user.id,
          patient_id: patientId,
          created_at: new Date().toISOString()
      ...
      toast.success(existingPatient ? 'Patient readmitted successfully' : 'Patient admitted successfully');
